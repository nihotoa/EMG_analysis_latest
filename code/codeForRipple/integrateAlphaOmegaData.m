...
common_frequency: [double], target sampling rate for resampling data
record_time: [double], total recording time in seconds

[output arguments]
CAI_struct: [struct], contains formatted CAI data with fields:
    - CAI_XXX: [double array], CAI signal data
    - CAI_XXX_KHz: [double], sampling rate [kHz]
...
CTTL_struct: [struct], contains formatted CTTL data with fields:
    - CTTL_XXX_Up: [double array], timing of signal onset
    - CTTL_XXX_Down: [double array], timing of signal offset
    - CTTL_XXX_TimeBegin: [double], start time of recording
    - CTTL_XXX_TimeEnd: [double], end time of recording
