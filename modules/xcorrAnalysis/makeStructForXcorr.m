...
for day_id = 1:day_num
    ...
    data_str.task_range.cutout_range.whole_trial = whole_task_EMG_struct.cutout_range;
    data_str.task_range.plot_range.whole_trial = [0 100];
    ref_activity_data = whole_task_EMG_struct.time_normalized_EMG;
    for element_id = 1:element_num
        data_str.activity_data.(unique_day_name).whole_trial.(elements{element_id}) = ref_activity_data(element_id, :);
    end
end
end