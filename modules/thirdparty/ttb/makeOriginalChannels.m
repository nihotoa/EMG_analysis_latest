...
% field�̉�͂�����Ƃ��̃f�t�H���g   processID   = 1:10
% unit�̉�͂�����Ƃ��̃f�t�H���g    processID   = 101:119
% ICMS�̉�͂�����Ƃ��̃f�t�H���g    processID   = 201
% ����p�r                          processID   = 30x
% PT stim�̉�͂�����Ƃ��̃f�t�H���g processID   = 401
% Synergy��͂���Ƃ��̃f�t�H���g�@�@prpcessID    = 501:
% SCI Synergy��͂���Ƃ��̃f�t�H���g�@�@prpcessID    = 601:
...
%
% 7 �etimestamp��interval���������������݂���悤�ɂ���v���Z�X�i�d�v�j
% !!!!!!again!!!!!!
...
% if(nargin<1)
%     pathname    = uigetdir(matpath,'Experiment��I�����Ă�������');
% end
...
if(any(ismember(1,processID)))
    ...
    % Data
    % detrend
    bpw     = SampleRate*300;       % 5���Ԃ̃f�[�^�̒���
    if(nData >= bpw)                    % detrend bp�����ɂ��钷��������Ƃ�����
        nbp     = floor(nData/bpw);
...
if(any(ismember(4,processID)))
    ...
    if(exist(fullfile(pathname,'Field 1.mat'),'file') && ~exist(fullfile(pathname,'Field 2.mat'),'file'))
        ...
        if(size(Y1.Data,2)==1)                        %  �ŏ��ƍŌ�̃g���C�A�����̂Ă�(PSTH��WCOH������ۂ̃}�[�W�����Ƃ��Ă�������)
            Y1.Data(:,1)=[];
...
%     save(fullfile(pathname,T2.Name,'.mat']),'-struct','T2');
    % T2  = filterTimestampChannel('Grip Onset candidate1', 'timestamp occurred', T2, T1, [-0.5 0.5]);   % candidate1 detector���߂��ɂ�����̂���
    % save(fullfile(pathname,T2.Name,'.mat']),'-struct','T2');
    T2  = filterTimestampChannel('Grip Onset candidate3', 'timestamp occurred', T2, ch3, [-0.5 1.0]);  % candidate3�@CentT Enter On���߂��ɂ�����̂���
%     save(fullfile(pathname,T2.Name,'.mat']),'-struct','T2');

    T2  = filterTimestampChannel('Grip Onset candidate2', '~timestamp occurred', T2, T2, [-1.0 -0.001]);   % candidate2  ���O�ɂق���candidate���Ȃ����̂���
%     save(fullfile(pathname,T2.Name,'.mat']),'-struct','T2');
    % T2  = filterTimestampChannel('Grip Onset candidate4', 'timestamp occurred', T2, ch4, [-1.25 0.5]);  % candidate3�@Out1 Off���߂��ɂ�����̂���
    % save(fullfile(pathname,T2.Name,'.mat']),'-struct','T2');

    Y1  = filterTimestampChannel('Grip Onset', 'within interval', T2, ch5);
    Y1  = filterTimestampChannel('Grip Onset', '~timestamp occurred', Y1, Y1, [-3 -0.001]);   % within interval filter���������������x���O�ɂق���candidate���Ȃ����̂������e�g���C�A�����ɂ͂P��timestamp�����ɂ���B
...
%     save(fullfile(pathname,T2.Name,'.mat']),'-struct','T2');
    ...
    T2  = filterTimestampChannel('Release Onset candidate1', 'timestamp occurred', T2, ch2, [-0.5 1.0]);  % candidate3�@OutT2 Enter On������ɂ�����̂���
%     save(fullfile(pathname,T2.Name,'.mat']),'-struct','T2');

    T2  = filterTimestampChannel('Release Onset candidate2', '~timestamp occurred', T2, T2, [-1.0 -0.001]);   % candidate2  ���O�ɂق���candidate���Ȃ����̂���
%     save(fullfile(pathname,T2.Name,'.mat']),'-struct','T2');

    %     T2  = filterTimestampChannel('Release Onset candidate3', 'timestamp occurred', T2, ch3, [-1.25 0.5]);  % candidate3�@Out1 Off���߂��ɂ�����̂���
    %     save(fullfile(pathname,T2.Name,'.mat']),'-struct','T2');

    Y1  = filterTimestampChannel('Release Onset', 'within interval', T2, ch4);
    Y1  = filterTimestampChannel('Release Onset', '~timestamp occurred', Y1, Y1, [-3 -0.001]);   % within interval filter���������������x���O�ɂق���candidate���Ȃ����̂���
...
if(any(ismember(7,processID)))
    ...
    if(nDataY1==nDataY2 && nDataY1==nDataY3)
        display('Trial Interval, Grip Onset, Release Onset�͓����f�[�^���ɂȂ��Ă��܂�OK�I�I')
    else
        display('******** caution�I�I�I�I�I�I�@Trial Interval(',num2str(nDataY1),'), Grip Onset(',num2str(nDataY2),'), Release Onset(',num2str(nDataY3),')�͓����f�[�^���ɂȂ��Ă܂���@caution�I�I�I�I�I�I')
    end
...
if(any(ismember(11,processID)))
    ...
    if(size(a1.Data,2)==size(b1.Data,2) && size(a1.Data,2)==size(c1.Data,2) && size(a1.Data,2)==size(d1.Data,2) && size(a1.Data,2)==size(e1.Data,2) && size(a1.Data,2)==size(Y1.Data,2))
        display(['                                                                               �����f�[�^���ɂȂ��Ă��܂�------OK(',num2str(size(Y1.Data,2)),')'])
    else
        display('**** error                                                                               �����f�[�^���ɂȂ��Ă��܂���------Caution�I�I�I�I�I')
    end
...
if(any(ismember(103,processID)))
    disp('103')
    nsd = 2;    % Trial Interval���̃X�p�C�N����mean+_nsd���O��Ă�����̂�invalid�Ƃ��Ĕr������B
...
if(any(ismember(104,processID)))
    ...
    T2  = makeTimestampChannel('Grip Onset candidate0', 'rising threshold', ch2, th2); % candidate0
    save(fullfile(pathname,[T2.Name,'.mat']),'-struct','T2');
    T2  = filterTimestampChannel('Grip Onset candidate1', 'timestamp occurred', T2, T1, [0 0.5]);   % candidate1 detector�̒��O�ɂ�����̂���
    save(fullfile(pathname,[T2.Name,'.mat']),'-struct','T2');
    T2  = filterTimestampChannel('Grip Onset candidate2', 'nearest', T2, T1);                           % candidate2  detector�̒��߂ɂ������
    save(fullfile(pathname,[T2.Name,'.mat']),'-struct','T2');
    T2  = filterTimestampChannel('Grip Onset candidate3', 'timestamp occurred', T2, ch3, [-0.5 1.0]);  % candidate3�@CentT Enter On���߂��ɂ�����̂���
    save(fullfile(pathname,[T2.Name,'.mat']),'-struct','T2');
    T2  = filterTimestampChannel('Grip Onset candidate4', 'signal stays low', T2, ch1, [-1 -0.5], th1);% ���O�icontrol period�j��Torque���O�ɋ߂��l���Ƃ��Ă������
    save(fullfile(pathname,[T2.Name,'.mat']),'-struct','T2');
    
%     T2  = filterTimestampChannel('Grip Onset candidate2', '~timestamp occurred', T2, T2, [-1.0 -0.001]);   % candidate3  ���O�ɂق���candidate���Ȃ����̂���
...
if(any(ismember(105,processID)))
    ...
    save(fullfile(pathname,[T2.Name,'.mat']),'-struct','T2');
    T2  = filterTimestampChannel('Grip Offset candidate1', 'timestamp occurred', T2, ch3, [-1.0 -0.001]);  % candidate1�@Grip On���߂��ɂ�����̂���
    save(fullfile(pathname,[T2.Name,'.mat']),'-struct','T2');
    T2  = filterTimestampChannel('Grip Offset candidate2', 'nearest', T2, ch3);                          % candidate1�@Grip On�̒��߂ɂ������
    save(fullfile(pathname,[T2.Name,'.mat']),'-struct','T2');   
    
%     T2  = filterTimestampChannel('Grip Offset candidate2', '~timestamp occurred', T2, T2, [0.001 1.0]);   % candidate2  ����ɂق���candidate���Ȃ����̂���
%     save(fullfile(pathname,[T2.Name,'.mat']),'-struct','T2');
    
    Y1  = filterTimestampChannel('Grip Offset', 'within interval', T2, ch5);
    Y1  = filterTimestampChannel('Grip Offset', '~timestamp occurred', Y1, Y1, [-3 -0.001]);   % within interval filter���������������x���O�ɂق���candidate���Ȃ����̂������e�g���C�A�����ɂ͂P��timestamp�����ɂ���B
...
%     ch4 = load(fullfile(pathname,'CentT Off'));
    ...
    save(fullfile(pathname,[T2.Name,'.mat']),'-struct','T2');
%     T2  = filterTimestampChannel('Release Onset candidate1', 'timestamp occurred', T2, T1, [0 0.5]);   % candidate1 detector���߂��ɂ�����̂���
    T2  = filterTimestampChannel('Release Onset candidate1', 'timestamp occurred', T2, T1, [0 1.0]);   % candidate1 detector���߂��ɂ�����̂��� SuuT�̂�

    save(fullfile(pathname,[T2.Name,'.mat']),'-struct','T2');
    T2  = filterTimestampChannel('Release Onset candidate2', 'nearest', T2, T1);                          % candidate2  detector�̒��߂ɂ������
    save(fullfile(pathname,[T2.Name,'.mat']),'-struct','T2');
%     T2  = filterTimestampChannel('Release Onset candidate3', 'timestamp occurred', T2, ch3, [-0.5 1.0]);  % candidate3�@OutT2 Enter On���߂��ɂ�����̂���
        T2  = filterTimestampChannel('Release Onset candidate3', 'timestamp occurred', T2, ch3, [-0.5 1.5]);  % candidate3�@OutT2 Enter On���߂��ɂ�����̂���SuuT�̂�
...
if(any(ismember(107,processID)))
    ...
    save(fullfile(pathname,[T2.Name,'.mat']),'-struct','T2');
    T2  = filterTimestampChannel('Release Offset candidate1', 'timestamp occurred', T2, ch3, [-1.0 -0.001]);  % candidate1�@Release On���߂��ɂ�����̂���
    save(fullfile(pathname,[T2.Name,'.mat']),'-struct','T2');
    T2  = filterTimestampChannel('Release Offset candidate2', 'nearest', T2, ch3);                          % candidate1�@Release On�̒��߂ɂ������
    save(fullfile(pathname,[T2.Name,'.mat']),'-struct','T2');   
%     
%     T2  = filterTimestampChannel('Release Offset candidate2', '~timestamp occurred', T2, T2, [0.001 1.0]);   % candidate2  ����ɂق���candidate���Ȃ����̂���
%     save(fullfile(pathname,[T2.Name,'.mat']),'-struct','T2');
    
    Y1  = filterTimestampChannel('Release Offset', 'within interval', T2, ch5);
    Y1  = filterTimestampChannel('Release Offset', '~timestamp occurred', Y1, Y1, [-3 -0.001]);   % within interval filter���������������x���O�ɂق���candidate���Ȃ����̂������e�g���C�A�����ɂ͂P��timestamp�����ɂ���B
...
%     T2  = filterTimestampChannel('Release Offset candidate1', 'timestamp occurred', T2, ch2, [-1.0 -0.001]);  % candidate3�@'Release Onset'�����O�ɂ�����̂���
% %     save(fullfile(pathname,[T2.Name,'.mat']),'-struct','T2');%disp(fullfile(pathname,Y1.Name));
%     T2  = filterTimestampChannel('Release Offset candidate2', '~timestamp occurred', T2, T2, [-1.0 -0.001]);   % candidate2  ���O�ɂق���candidate���Ȃ����̂���
% %     save(fullfile(pathname,[T2.Name,'.mat']),'-struct','T2');%disp(fullfile(pathname,Y1.Name));
% 
%     Y1  = filterTimestampChannel('Release Offset', 'within interval', T2, ch4);
%     Y1  = filterTimestampChannel('Release Offset', '~timestamp occurred', Y1, Y1, [-3 -0.001]);   % within interval filter���������������x���O�ɂق���candidate���Ȃ����̂���
...
if(any(ismember(109,processID)))
    disp('109')
    ch1 = load(fullfile(pathname,'OutT1 Enter On'));
    ch1 = filterTimestampChannel(ch1.Name, '~timestamp occurred', ch1, ch1, [-3.0 -0.001]);   % ���O�ɂق��̎������Ȃ����̂���
...
if(any(ismember(114,processID)))
    ...
    % FDI(uV).mat�Ȃ�unrectified EMG�̖��O��T���B
    
    EMG_name_list    = findEMG(dirmat(pathname));
...
% Aoba�Ō�����DetectionPulse�̃m�C�Y���������邽�߁A
% EMG(uV)��EMG(uV)_original�ƃ��l�[�����āA
% remove artifact���������̂�EMG(uV)�A
% �����rectify�������̂�lEMGl(uV)�Ƃ���B
...
%% 999
% % �����̎�Ⴂ��lEMGl(uV).mat�t�@�C�������������Ă��܂����Ƃ��ɁAEMG(uV).mat�t�@�C�����畜������
...
%             EMG_name_list{nEMG}  = [files{ifile}(indl(1)+1:indl(end)-1),'(uV).mat'];
%             Name{nEMG}  = deext(files{ifile});
%         end
%     end
    
%     EMG_name_list    = dirmat(pathname);
...
%% 998
% % �����̎�Ⴂ��lEMG'l(uV).mat�t�@�C�������������Ă��܂����Ƃ��ɁAEMG'(uV).mat�t�@�C�����畜������
...
if(any(ismember(402,processID)))
    ...
    % PT stim evoked EMG����菜�����߂�Stim pulse��Stim pulse2��window[0
    % 0.02]sec��remove artifact
...
%         Y1  = filterTimestampChannel([ch1.Name,' (~withBGEMG)'], '~timestamp occurred', ch1, ch3, window2);
%         save(fullfile(pathname,[Y1.Name,'.mat']),'-struct','Y1');disp(fullfile(pathname,Y1.Name));
        % (1���ڂ�)�h���O��(-100-500ms)��RMS��th���Ⴂ���̂ɍi��B
...
%         if(~isempty(Y1.Data))
            ...
            if(BGEMG_flag)
%                 % (1���ڂ�)�h���O(500-0ms)��BGEMG���N�����Ă�����݂̂̂ɍi��B
...
%         end
    ...
    for iFreq=1:nFreq
        ...
        if(~isempty(Y1.Data))
            ...
            if(MEP_flag)
                % 1���ڂ̎h����(5-20ms)��MEP timestamps���N�����Ă�����݂̂̂ɍi��B
...
%                 save(fullfile(pathname,[X3.Name,'.mat']),'-struct','X3');disp(fullfile(pathname,X3.Name));
            ...
            % n���ڂ�Stimonset��timestamp����邽�߂ɁA(1/Freq * (n-1))�b�V�t�g������B
...
% 
    ...
    % Total Torque(N).mat��[0 480]sec��trim
