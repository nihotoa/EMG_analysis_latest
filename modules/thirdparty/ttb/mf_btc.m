...
% dth     = 0.003;        %%% duration threshold�@duration��3ms�ȏ�̂��̂�L�ӂƂ݂Ȃ��B
% fname   = 'sigpeakindTW';   %%% TW���̂��ׂĂ̗L�ӂȃs�[�N����MF���Z�o����
fname   = 'maxsigpeakindTW';  %%% TW����abs(peakd)���ő�̗L�ӂȃs�[�N����MF���Z�o����

ParentDir   = uigetdir(fullfile(datapath,'STA'),'SpTA�f�[�^�������Ă���e�t�H���_��I�����Ă��������B');
InputDirs   = uiselect(dirdir(ParentDir),1,'�ΏۂƂ���Experiments��I�����Ă�������');
OutputDir   = uigetdir(fullfile(datapath,'MF'),'�o�͐�t�H���_��I�����Ă��������B');
...
isAny         = false(1,length(EMG_name_list));
isAnyF        = isAny;
isAnyS        = isAny;
isPSE         = isAny;
isPSF         = isAny;  % 1
...
isSF          = isAny;  % 3
isSS          = isAny;  % 4
MPIs           = zeros(1,length(EMG_name_list));
PPIs           = MPIs;
APIs           = MPIs;
